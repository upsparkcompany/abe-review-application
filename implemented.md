...
- Reviewee Games: shared app-level audio keeps game cues preloaded across modal lifecycles; countdown modals wait for their countdown cues before displaying the visual three-second sequence, flash-card countdowns cue every 3–2–1 second, and each fresh game item silently primes its critical timer cue before it is needed. Answer reveals use distinct game-style correct cash-out and subtle incorrect feedback chimes.
